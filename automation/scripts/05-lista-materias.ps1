...
$CommitMessage = "feat: adiciona listagem editorial de materias"
...
Write-Host " JORNALIR - FASE 05 - LISTA DE MATERIAS" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
...
if ($Mode -eq "Preflight") {
    ...
    if (-not (Test-Path "packages/core/src/editorial/article-service.ts")) {
        Fail "ArticleService nao encontrado. Rode a Fase 04 antes desta."
    }

    if (-not (Test-Path "apps/sistema/src/composition/editorial.ts")) {
        Fail "Ponto de composicao do Editorial nao encontrado."
    }
    ...
    Write-Host ""
    Write-Host "Agora execute o trabalho da Fase 05 (rota /sistema/editorial/materias,"
    Write-Host "filtros e paginas de apoio, sem editor completo)."
    Write-Host ""
    Write-Host "Quando terminar, rode:"
    Write-Host ""
    Write-Host ".\automation\scripts\05-lista-materias.ps1 -Mode Finalizar" -ForegroundColor Yellow
    Write-Host ""
...
Write-Host ""
Write-Host "Validando a Fase 05..." -ForegroundColor Cyan
Write-Host ""
...
git add apps/sistema automation/prompts/05-lista-materias.md automation/scripts/05-lista-materias.ps1
...
Write-Host " FASE 05 CONCLUIDA" -ForegroundColor Green
Write-Host "==============================================" -ForegroundColor Green
Write-Host ""
