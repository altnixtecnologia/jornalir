...
$CommitMessage = "feat: cria shell administrativo do JornalIR"
...
Write-Host " JORNALIR - FASE 03 - SHELL ADMINISTRATIVO" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
...
if ($Mode -eq "Preflight") {
    ...
    Write-Host ""
    Write-Host "Agora execute no Codex o prompt da Fase 03."
    Write-Host ""
    Write-Host "Quando o Codex terminar, rode:"
    Write-Host ""
    Write-Host ".\automation\scripts\03-shell-administrativo.ps1 -Mode Finalizar" -ForegroundColor Yellow
    Write-Host ""
...
Write-Host ""
Write-Host "Validando a Fase 03..." -ForegroundColor Cyan
Write-Host ""

npm run typecheck --workspace @ir/sistema

if ($LASTEXITCODE -ne 0) {
    Fail "Typecheck falhou. Nao sera feito commit."
}

npm run build --workspace @ir/sistema

if ($LASTEXITCODE -ne 0) {
    Fail "Build falhou. Nao sera feito commit."
}
...
Write-Host " FASE 03 CONCLUIDA" -ForegroundColor Green
Write-Host "==============================================" -ForegroundColor Green
Write-Host ""
