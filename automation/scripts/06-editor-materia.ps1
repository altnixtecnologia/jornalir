...
$CommitMessage = "feat: adiciona cadastro e edicao de materias"
...
Write-Host " JORNALIR - FASE 06 - EDITOR DE MATERIA" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
...
if ($Mode -eq "Preflight") {
    ...
    if (-not (Test-Path "apps/sistema/src/app/sistema/editorial/materias/page.tsx")) {
        Fail "Listagem de materias nao encontrada. Rode a Fase 05 antes desta."
    }

    if (-not (Test-Path "packages/core/src/editorial/article-service.ts")) {
        Fail "ArticleService nao encontrado."
    }
    ...
    Write-Host ""
    Write-Host "Agora execute o trabalho da Fase 06 (formulario real de criacao e"
    Write-Host "edicao de materia, com capa/galeria e acoes de publicacao)."
    Write-Host ""
    Write-Host "Quando terminar, rode:"
    Write-Host ""
    Write-Host ".\automation\scripts\06-editor-materia.ps1 -Mode Finalizar" -ForegroundColor Yellow
    Write-Host ""
...
Write-Host ""
Write-Host "Validando a Fase 06..." -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Lembrete: valide manualmente criacao, edicao, publicacao e" -ForegroundColor Yellow
Write-Host "programacao contra os mocks antes de prosseguir, se ainda nao" -ForegroundColor Yellow
Write-Host "tiver feito nesta sessao." -ForegroundColor Yellow
Write-Host ""
...
git add apps/sistema packages/core packages/mocks automation/prompts/06-editor-materia.md automation/scripts/06-editor-materia.ps1
...
Write-Host " FASE 06 CONCLUIDA" -ForegroundColor Green
Write-Host "==============================================" -ForegroundColor Green
Write-Host ""
