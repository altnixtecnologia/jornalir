...
$CommitMessage = "feat: adiciona editor editorial de texto"
...
Write-Host " JORNALIR - FASE 07 - EDITOR EDITORIAL DE TEXTO" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
...
if ($Mode -eq "Preflight") {
    ...
    if (-not (Test-Path "apps/sistema/src/features/editorial/ArticleForm.tsx")) {
        Fail "Formulario de materia nao encontrado. Rode a Fase 06 antes desta."
    }
    ...
    Write-Host ""
    Write-Host "Agora execute o trabalho da Fase 07 (controle discreto de titulo/"
    Write-Host "subtitulo e editor de texto rico no corpo da materia)."
    Write-Host ""
    Write-Host "Quando terminar, rode:"
    Write-Host ""
    Write-Host ".\automation\scripts\07-editor-texto.ps1 -Mode Finalizar" -ForegroundColor Yellow
    Write-Host ""
...
Write-Host ""
Write-Host "Validando a Fase 07..." -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Lembrete: valide manualmente criacao e edicao com formatacao, e a" -ForegroundColor Yellow
Write-Host "preservacao do conteudo ao salvar/reabrir, se ainda nao tiver feito" -ForegroundColor Yellow
Write-Host "nesta sessao." -ForegroundColor Yellow
Write-Host ""
...
git add apps/sistema packages/core packages/types package.json package-lock.json automation/prompts/07-editor-texto.md automation/scripts/07-editor-texto.ps1
...
Write-Host " FASE 07 CONCLUIDA" -ForegroundColor Green
Write-Host "==============================================" -ForegroundColor Green
Write-Host ""
