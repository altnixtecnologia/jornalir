...
/**
 * Cliente do projeto Supabase `site-system-ir` (IR Core). Desde a Fase 19,
 * usado para autenticação real (`AuthProvider`) — o conteúdo editorial
 * (matérias, mídias, etc.) continua 100% sobre os providers mock de
 * `@ir/mocks` (ver docs/DATABASE-IR-CORE.md). Usa apenas a publishable key
 * (segura no cliente); nunca a service role.
 *
