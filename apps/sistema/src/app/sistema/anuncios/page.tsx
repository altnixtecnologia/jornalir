  ...
  return (
    <div className="legacy-module">
      ...
      <Dialog
        ...
        title={editingId ? "Editar anuncio" : "Novo anuncio"}
      >
        <div className="space-y-3">
          ...
          <Select
            ...
            onChange={(event) =>
              setForm((prev) => ({
                ...prev,
                formato: event.target.value as AdItem["formato"],
              }))
            }
          >
          ...
          <Select
            ...
            onChange={(event) =>
              setForm((prev) => ({
                ...prev,
                status: event.target.value as AdItem["status"],
              }))
            }
          >
          ...
          <div className="grid grid-cols-2 gap-2">
            <Input
              ...
              value={form.inicio}
              onChange={(event) =>
                setForm((prev) => ({ ...prev, inicio: event.target.value }))
              }
            />
            <Input
              type="date"
              value={form.fim}
              onChange={(event) =>
                setForm((prev) => ({ ...prev, fim: event.target.value }))
              }
            />
          </div>
